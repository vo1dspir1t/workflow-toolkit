...
- [ ] Установщик переделать на Py -> Exe (Создаёт необходимые директории, с помощью библиотеки Git клонирует проект, полноценно разворачивает и запускает)
...
- [x] Отрефакторить установку зависимости через map